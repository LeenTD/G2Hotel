...
//    public Booking(int IDBooking, int IDAccount, int IDDiscount, int IDRoomType, String FullName, String Gender, String Email, String Phone, int Adult, int Child, String CheckIn, String CheckOut, int NumberOfRooms, double TotalPrice, String BookingTime, String Note) {
//        this.IDBooking = IDBooking;
//        this.IDAccount = IDAccount;
//        this.IDDiscount = IDDiscount;
//        this.IDRoomType = IDRoomType;
