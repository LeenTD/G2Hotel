...
//        vnp_Params.put("vnp_IpAddr", vnp_IpAddr);
        ...
        String vnp_SecureHash = Config.hmacSHA512(Config.vnp_HashSecret, hashData.toString()); //hashsecret: mã kiểm tra đảm bảo dữ liệu không bị thay đổi trong quá trình chuyển từ merchant sang vnpay
